...
class MetaController extends Controller
{
    ...
    public function spirits(): JsonResponse
    {
        return response()->json([
            ...
            ['animal_key' => 'hamster',  'zh_name' => '倉鼠',   'spirit_title' => '積攢之精靈', 'element' => '秋日豐收', 'gift' => '相信小小的累積',           'mythology' => '北歐世界樹 Yggdrasil 根部的守藏者',      'motto' => '一點一點來，小習慣勝過大計畫 🌰'],
            ['animal_key' => 'fox',      'zh_name' => '狐狸',   'spirit_title' => '智慧之精靈', 'element' => '晨霧',     'gift' => '識破美食陷阱',             'mythology' => '北歐詭計之神 Loki 的徒弟',               'motto' => '聰明地吃，不必委屈地餓 🦊'],
            ['animal_key' => 'shiba',    'zh_name' => '柴犬',   'spirit_title' => '陪伴之精靈', 'element' => '夕陽散步', 'gift' => '每天一起動一下',           'mythology' => '忠犬 Garmr 的溫柔支線版本',              'motto' => '走一下啦，走 10 分鐘也好 🐕'],
            ...
            ['animal_key' => 'tuxedo',   'zh_name' => '賓士貓', 'spirit_title' => '自由之精靈', 'element' => '午夜街巷', 'gift' => '拒絕的勇氣',               'mythology' => '希臘交叉路口女神 Hecate 的伴獸',         'motto' => '你值得的東西，從來不用將就 🖤'],
        ]);
    }
}
