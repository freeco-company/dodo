    ...
    public function run(): void
    {
        ...
        $articles = [
            [
                ...
                'body' => "❌ 體態管理期避開：\n- 豚骨 / 濃厚 / 辣味拉麵\n- 唐揚雞 / 可樂餅 / 炸豬排\n\n⭕ 體態管理期可以選：\n- 醬油 / 味噌 / 鹽味拉麵（清湯底）\n- 配蔬菜 + 蛋白質（溏心蛋 / 燙青菜 / 海帶）\n\n2 個關鍵：麵份量一拳頭、不喝湯。",
                'dodo_voice_body' => "體態管理期想吃日式拉麵？朵朵教妳挑 🍜\n\n❌ 避開區\n• 豚骨 / 濃厚 / 辣味拉麵（湯底油重）\n• 唐揚雞 / 可樂餅 / 炸豬排（炸物配菜）\n\n⭕ OK 區\n• 醬油 / 味噌 / 鹽味拉麵\n• 配蔬菜 + 蛋白質（溏心蛋、燙青菜、海帶）\n\n💡 兩個鐵則\n• 麵 = 一拳頭份量\n• 不喝湯（湯油超多！）\n\n清湯系 + 控份量 = 拉麵也能吃 ✨",
            ...
            [
                ...
                'tags' => ['運動', '代謝保健', '科學'],
                'audience' => ['retail', 'franchisee'],
                'summary' => '低強度燒脂肪、高強度燒醣類；時間越長脂肪比例越高。中強度有氧 = 代謝保健甜蜜點。',
                'body' => "運動代謝保健科學：\n- 低強度（瑜伽、散步）：能量主要來源 = 脂肪\n- 中強度（騎車、游泳）：能量 = 脂肪 + 醣類\n- 高強度（跳繩、跑步）：能量主要來源 = 醣類\n\n原則：強度越高，醣類比例越高；時間越長，脂肪比例越高。\n\n代謝保健甜蜜點 = 中強度有氧 + 持續 30 分鐘以上。",
            ...
            [
                ...
                'tags' => ['運動', '比較', '日常運動搭配'],
                'audience' => ['retail', 'franchisee'],
                'summary' => '無氧短時間高強度、日常運動搭配長代謝；有氧長時間低強度、燒脂但代謝下降。',
                'body' => "對比：\n- 持續時間：無氧較短 / 有氧較長\n- 運動強度：無氧較高 / 有氧較低\n- 燃燒脂肪：兩者都可以\n- 肌肉量、基礎代謝率：無氧上升 / 有氧下降\n\n類型：\n- 無氧：重量訓練、徒手肌力、TRX、舉重、短跑\n- 有氧：快走、慢跑、騎自行車、游泳、有氧舞蹈、拳擊、飛輪\n\n建議：兩者搭配，無氧日常運動搭配 + 有氧燒脂。",
                'dodo_voice_body' => "體態管理該做有氧還是無氧？朵朵幫妳對比 💪\n\n📊 |  | 無氧 | 有氧 |\n• 時間：短 / 長\n• 強度：高 / 低\n• 燒脂：✓ / ✓\n• 肌肉量：↑ / ↓ (！)\n\n等等，有氧會掉肌肉？\n→ 對，純有氧長期做基礎代謝會降\n\n🏋️ 無氧：重訓、TRX、舉重、短跑\n🏃 有氧：快走、慢跑、騎車、游泳、飛輪\n\n💡 黃金搭配：\n無氧日常運動搭配 + 有氧燒脂（兩者都做）\n\n光跑步不重訓，越減越難減 ✨",
                'reading_time_seconds' => 90,
            ...
            [
                ...
                'body' => "阻力訓練 = 用不同方式（彈力帶、負重等）訓練肌肉。\n\n相比有氧：\n- 更能刺激肌肉生長\n- 讓肌肉受到輕微損傷後進行修復\n- 修復過程 = 增加肌肉量與肌肉力量\n\n所以想日常運動搭配 / 維持基礎代謝 / 預防肌少症 → 阻力訓練優先於有氧。",
