    ...
    public function run(): void
    {
        ...
        $articles = [
            ...
            [
                ...
                'title' => '低糖選擇 食物挑選 6 重點',
                'category' => 'qna',
                'tags' => ['GI', '體態管理期', '食材'],
                'audience' => ['retail', 'franchisee'],
                'summary' => '未加工 / 高纖 / 短烹調 / 原型 / 含酸 / 簡單烹調 — 6 個面向挑低糖選擇 食物。',
                'body' => "低糖選擇 食物挑選 6 個面向：\n1. 未加工精緻化：燕麥 > 燕麥奶\n2. 膳食纖維高：地瓜 > 白飯\n3. 烹調時間短：白飯 > 粥（煮越久 GI 越高）\n4. 原型食材：新鮮水果 > 奇異果汁\n5. 含酸量高：芭樂 > 西瓜\n6. 烹調方式簡單：清蒸 > 油炸\n\n注意：低糖選擇 吃多一樣會胖。控量 + 選對食物雙管齊下。",
