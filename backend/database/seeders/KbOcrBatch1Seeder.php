    ...
    public function run(): void
    {
        ...
        $articles = [
            ...
            [
                ...
                'body' => "「全麥吐司」聽起來很健康，但市售品多用全麥麵粉與一般麵粉混合，仍屬於精緻澱粉。常見成分還有花生油、棕櫚油、糖漿、酵母、抗氧化劑等添加物。容易吃過量、吃不飽。想吃複合碳水建議改選地瓜、南瓜、馬鈴薯、燕麥、雜糧。",
            ...
            [
                ...
                'title' => '減脂期鐵板燒怎麼吃 — 1000 → 500 大卡',
                'category' => 'cutting',
                'tags' => ['鐵板燒', '減脂期', '外食'],
                'audience' => ['retail', 'franchisee'],
                'summary' => '一般鐵板燒套餐 1000 大卡，調整一下能砍半到 500 大卡。',
                'body' => "一般鐵板燒：主餐 + 飯 1 碗 + 紅茶 1 杯 ≈ 1000 大卡\n減脂版：乾煎肉類/海鮮 + 少油少鹽 + 飯半碗或不吃 ≈ 500 大卡\n\n關鍵 3 招：\n1. 主餐改乾煎，避免重醬汁\n2. 跟廚師說「少油少鹽」\n3. 飯減半或不吃，改加蔬菜",
                'dodo_voice_body' => "減脂期還想吃鐵板燒？朵朵教妳腰斬熱量 ✨\n\n一般版：1000 大卡\n• 主餐\n• 飯 1 碗\n• 紅茶 1 杯（含糖）\n\n↓ 簡單調整 ↓\n\n減脂版：500 大卡\n• 乾煎肉類/海鮮（避開重醬）\n• 少油少鹽（直接跟師傅說）\n• 飯半碗或不吃，改加蔬菜\n\n3 招：乾煎、少油少鹽、飯減半\n\n外食也能跟身材好朋友 💪",
                'reading_time_seconds' => 75,
            ...
            [
                ...
                'body' => "中式紅燈烹調法：炸、酥、爆、煎、糖醋、三杯、炒、紅燒、燴。\n共通點：油量大、調味重、糖鹽多、加工程度高。減脂期或在意身材時減少頻率，偶爾解饞 OK。",
                'dodo_voice_body' => "中式料理紅燈區 — 偶爾吃就好的款 🔴\n\n• 炸 / 酥（裹粉油炸，熱量翻倍）\n• 爆（重油快炒）\n• 煎（用油量多）\n• 糖醋（糖 + 油 + 醬）\n• 三杯（醬油糖油全套）\n• 炒（看用油量）\n• 紅燒（醬油 + 糖 + 油）\n• 燴（勾芡 + 油）\n\n不是不能吃，是頻率問題。\n減脂期一週 1-2 次當解饞，其他餐回到綠燈區 ✨",
                'reading_time_seconds' => 60,
