    ...
    public function run(): void
    {
        ...
        $articles = [
            [
                ...
                'summary' => '加工品讓身體發炎、越吃越餓；低加工天然食材滿足感高、不易胖。',
            ...
            [
                ...
                'title' => '體態管理期麥當勞怎麼點 — 漢堡 / 炸雞篇',
                'category' => 'cutting',
                'tags' => ['速食', '麥當勞', '體態管理期', '外食'],
                'audience' => ['retail', 'franchisee'],
                'summary' => '麥當勞也能體態管理吃，主餐去培根 / 去炸皮，配四季沙拉，飲料無糖。',
                'body' => "體態管理期麥當勞點法（漢堡 / 炸雞篇）：\n\n主餐擇一：\n- 義式烤雞沙拉\n- 吉事漢堡\n- 嫩煎雞腿堡\n- BLT 安格斯牛肉堡（去培根）\n- BLT 嫩煎雞腿堡（去培根）\n- 麥脆雞腿（去炸皮）\n\n配餐：四季沙拉（不加醬 / 和風醬）\n飲料：無糖紅茶 / 無糖綠茶 / 美式咖啡 / 可口可樂 ZERO",
                'dodo_voice_body' => "體態管理期想吃麥當勞？朵朵教妳選 ✨\n\n🍔 主餐擇一\n• 義式烤雞沙拉\n• 吉事漢堡\n• 嫩煎雞腿堡\n• BLT 安格斯牛肉堡（去培根）\n• BLT 嫩煎雞腿堡（去培根）\n• 麥脆雞腿（去炸皮！）\n\n🥗 配餐\n四季沙拉（不加醬 / 和風醬）\n\n🥤 飲料\n無糖紅 / 無糖綠 / 美式 / Coke ZERO\n\n關鍵字：「去培根」「去炸皮」「無糖」\n外食也能體態管理 💪",
            ...
            [
                ...
                'title' => '體態管理期麥當勞 — 想吃薯條版',
                'category' => 'cutting',
                'tags' => ['速食', '麥當勞', '體態管理期'],
                'audience' => ['retail', 'franchisee'],
                'summary' => '想吃薯條時的體態管理組合：主餐選沙拉或去皮雞腿，配中薯（去鹽），無糖飲料。',
                'body' => "體態管理期想吃薯條也行，這樣搭：\n\n主餐擇一：\n- 義式烤雞沙拉\n- 麥脆雞腿（去炸皮）\n\n配餐：中薯條（去鹽）\n飲料：無糖紅茶 / 無糖綠茶 / 美式咖啡 / 可口可樂 ZERO\n\n關鍵：薯條已經有油脂，主餐就不選炸物 + 漢堡 + 飲料無糖。",
