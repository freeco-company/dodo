...
| 項目 | 內容 |
|---|---|
| 定位 | **健康行為 OS** — 飲食 + 計步 + 斷食 + 體重 + 睡眠 + AI 教練 + 遊戲化養成（2026-05-02 從「AI 飲食教練」擴大） |
| TA | 25-40 歲台灣女性減脂 / 體態管理 / 健康習慣養成 |
| 商業模式 | **純訂閱**（Free / NT$290/mo / 年付 NT$2,400 / VIP NT$6,000/yr）— **不靠加盟漏斗變現** |
| 通路 | App Store / Google Play / LINE Bot / Web demo |
| 北極星指標 | D30 留存率 > 35% |
| Guard rails | 月平均 AI 成本 < NT$80/活躍用戶；食物辨識準確率 > 85% |
| ARR 目標（保守） | 5 萬 MAU × 7% 訂閱率 × NT$320 × 12 ≈ NT$1,344 萬/年 |

### 🚧 商業紅線（2026-05-02 拍板，不可違反）

**獨立 App 感受**：對未綁母艦 / 未在婕樂纖消費過的用戶，App 內**完全不出現任何加盟 CTA**（含 banner、icon、文案暗示）。加盟漏斗 backend publisher / lifecycle / metrics 繼續埋資料（背景跑），但 frontend zero 加盟入口。

加盟對話只在**雙條件**成立才在「我的 → 婕樂纖會員」深層出現：
1. 母艦有 ≥1 筆婕樂纖商品訂單
2. meal 高活躍（連勝 30+ 或付費訂閱中）

或用戶主動在朵朵 chat 提問加盟相關 → 朵朵自然回應。

**為什麼**：加盟對象是愛用者（母艦消費過、信任品牌），不是隨機 App 下載者。「記錄飲食用一用突然問你要不要加盟」會讓人反感，傷害 App 獨立性。對齊 ADR-008（qualified 訊號源 = 母艦首單）。

### 🎯 6 鉤子補強優先序（2026-Q2，純為訂閱站穩）

1. **拍照 AI 估熱量打磨** — 對標 Cal AI / SnapCalorie；獲客 + 訂閱主鉤子；現有 ai-service 已有雛形
2. **斷食 timer**（16:8 / 18:6 / OMAD / 5:2） — 對標 Zero / Yazio；留存 + paywall sweet spot
3. **Apple HealthKit / Google Health Connect 整合** — 步數 / 體重 / 睡眠免手動
4. **每週朵朵 AI 報告**（PDF / 圖卡可分享） — 續訂 + 有機獲客（分享回饋）
5. **進度照相簿 + 朵朵點評** — VIP tier 差異化、情緒鉤子最強
6. **季節限定 outfit + Cards 收藏完整度 paywall** — 既有功能變現深挖

**戰略放掉**：HRV / 壓力（要 Watch、受眾窄）、真人社群比較 / 排行榜（toxicity 與朵朵語氣衝突）、食物資料庫深度（用 AI 拍照繞過 MFP）。

### 💰 訂閱定價分層

| Tier | 價格 | 內容 |
|---|---|---|
| Free | NT$0 | 朵朵每日 1 次點評 / 拍照 AI 3 次/天 / 基本記錄 / 連勝 / 步數 / 基礎 outfit |
| Monthly | NT$290/mo | 無限拍照 AI + 朵朵深度 chat + 斷食 timer + 週報 + 進階 macro + 季節 outfit + 解鎖 Island 後續章節 |
| Yearly | NT$2,400/yr（節省 30%） | Monthly + 進度照相簿 + 月報 |
| VIP | NT$6,000/yr | Yearly + 真人營養師 1 對 1 諮詢 1 次/季 + 朵朵客製化計畫 + 獨家 outfit |
